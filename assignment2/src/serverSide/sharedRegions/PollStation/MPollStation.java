...
import serverSide.sharedRegions.Repository.IRepo_PollStation;
...
public class MPollStation {
     ...
     */
    public static MPollStation getInstance(int capacidadeMax, IRepo_PollStation logs) {
        if (instance == null) {
    ...
    /**
     * The isPSclosedAfter method returns a flag that indicates if the polling station is closed after the election.
     * 
