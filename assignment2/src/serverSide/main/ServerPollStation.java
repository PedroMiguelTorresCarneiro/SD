...
import serverSide.entities.PollStationClientProxy;
 ...
 */
public class ServerPollStation {
     /**
   ...
   */
   ...
   {
      PollStation pollStation;                                              // barber shop (service to be rendered)
      PollStationInterface pollSInter;                              // interface to the barber shop
     ...
     /* service is established */
      ...
      pollStation = new PollStation (reposStub);                                      // service is instantiated
      pollSInter = new PollStationInterface(pollStation);                            // interface to the service is instantiated
     ...
     /* service request processing */
      ...
      PollStationClientProxy cliProxy;                                // service provider agent

      waitConnection = true;
      while (waitConnection)
      { try
        { sconi = scon.accept ();                                    // enter listening procedure
          cliProxy = new PollStationClientProxy(sconi, pollSInter);    // start a service provider agent to address
