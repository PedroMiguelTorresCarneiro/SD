...
import serverSide.entities.RepoClientProxy;
...
public class ServerRepository  {
   ...
   */
   ...
   {
      Repo repo;                                              // barber shop (service to be rendered)
      RepoInterface repoInter;                              // interface to the barber shop
     ...
     /* service is established */
      ...
      repo = new Repo (reposStub);                                      // service is instantiated
      repoInter = new RepoInterface(repo);                         // interface to the service is instantiated
     ...
     /* service request processing */
      ...
      RepoClientProxy cliProxy;                                // service provider agent

      waitConnection = true;
      while (waitConnection)
      { try
        { sconi = scon.accept ();                                    // enter listening procedure
          cliProxy = new RepoClientProxy(sconi, repoInter);    // start a service provider agent to address
